...
const UsersPage: React.FC = () => {
    ...
    const columns: GridColDef<User>[] = [
        ...
        { field: 'username', headerName: 'Ім\'я користувача', flex: 1, minWidth: 180, sortable: true },
        { field: 'wins', headerName: 'Перемог', type: 'number', width: 100, sortable: true },
        { field: 'losses', headerName: 'Поразок', type: 'number', width: 100, sortable: true },
        { field: 'streak_count', headerName: 'Стрік', type: 'number', width: 90, sortable: true },
        { field: 'is_verified', headerName: 'Верифікований', type: 'boolean', width: 130, sortable: true },
        { field: 'is_admin', headerName: 'Адмін', type: 'boolean', width: 100, sortable: true },
        {
            field: 'is_banned', headerName: 'Забанений', type: 'boolean', width: 120, sortable: true,
            renderCell: (params: GridRenderCellParams<User, boolean>) => (
                <Chip label={params.value ? 'Так' : 'Ні'} color={params.value ? 'error' : 'default'} size="small" />
            )
        },
        {
            field: 'ban_reason', headerName: 'Причина бану', flex: 1, minWidth: 150, sortable: false,
        ...
        {
            field: 'is_muted', headerName: 'Мут чату', type: 'boolean', width: 120, sortable: true,
            renderCell: (params: GridRenderCellParams<User, boolean>) => (
                <Chip label={params.value ? 'Так' : 'Ні'} color={params.value ? 'warning' : 'default'} size="small" />
            )
        },
        {
            field: 'actions',
