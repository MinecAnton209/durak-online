...
<template>
  <BaseModal :is-open="isOpen" :title="title" @close="handleClose">
    <form @submit.prevent="handleSubmit" class="flex flex-col gap-5">
      ...
      <div class="space-y-1.5">
        ...
        <div class="relative">
          <input
            v-model="username"
            type="text"
            class="w-full min-h-[48px] bg-black/20 border border-outline/50 rounded-xl px-4 py-3 text-on-surface focus:border-primary focus:ring-1 focus:ring-primary/50 focus:outline-none transition-all pl-10"
      ...
      <button
        type="submit"
        :disabled="isLoading"
        class="mt-2 min-h-[48px] w-full bg-primary text-on-primary font-bold text-lg py-3 rounded-xl hover:bg-[#00A891] hover:shadow-lg hover:shadow-primary/20 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center"
      >
