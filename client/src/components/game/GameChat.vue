...
<template>
  ...
  <div class="sm:hidden">
    ...
    <button @click="toggleChat"
            class="fixed bottom-20 sm:bottom-6 right-6 z-50 bg-surface border border-white/10 w-14 h-14 rounded-full flex items-center justify-center shadow-lg active:scale-95 transition-all relative group">
