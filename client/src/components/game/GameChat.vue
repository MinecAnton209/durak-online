...
<template>
  ...
  <div class="sm:hidden">
    ...
    <button @click="toggleChat"
            class="fixed bottom-44 sm:bottom-6 right-4 z-50 bg-surface border border-white/10 w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shadow-lg active:scale-95 transition-all relative group">
